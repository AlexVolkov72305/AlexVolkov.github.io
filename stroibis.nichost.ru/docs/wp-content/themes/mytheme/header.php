    ...
    <div class="container">
        <div class="row">
            <div class="col-md-2 logo">
                <a href="http://stroibis.nichost.ru/" class="lang-icon" title="RUS"><img src="http://stroibis.nichost.ru/wp-content/themes/myTheme/img/rus.png" /></a> <a href="http://stroibis.nichost.ru/en/" class="lang-icon" title="ENG"><img src="http://stroibis.nichost.ru/wp-content/themes/myTheme/img/eng.png" /></a> <a href="<?=home_url();?>">Fasovkin.ru</a>
            </div>
        ...
        <?if (is_page(6)){?>
            <div class="row title">
                <div class="col-md-6">
                    ...
                    <p>на современном оборудовании и в короткий срок</p>
                    <div class="separator"></div>
                </div>
            </div>  
            <div class="row descr">
                <div class="col-md-4">
                    <p>Мы оказываем услуги по дроблению, смешиванию, фасовки, брикетированию, упаковке сыпучей продукции более 10 лет, имеем большой опыт в данной области и успели зарекомендовать себя профессиональным и надёжным партнером.</p>
                </div>
            </div>
        <?}else{}?>
    </div>
